...
void setup() {
  ...
  strokeWeight(1);
  //  circleLine(0, pg.height, (int)dist(0, pg.height, pg.width, 0)*2, 0.07, #dd2222);
...
void circleLine(int cx, int cy, int r, float speed, color clbg) {
  ...
  while (angle<= radians (limit)) {
    //stroke((int)random(50,200),(int)random(50,150),(int)random(50,130));
    pg.stroke(clbg);
